            ...
            <>
                ...
                >
                    <View style={{ flex: 1, justifyContent: 'flex-end' }}>
                        ...
                        <Animated.View style={{ ...StyleSheet.absoluteFill,top:null,flex: 1, backgroundColor: "#ffffff", borderTopLeftRadius: 50, borderTopRightRadius: 50, overflow: "hidden", padding: 25,opacity:opaqueOp,transform: [{
                                translateY: translationOp
                            },],zIndex:indexOp }} >
                            <Text onPress={() => this.poser()} style={{ fontSize: 40, textAlign: 'center', margin: 5, fontFamily: 'PatrickHand-Regular' }}>Food Gapp</Text>
                            ...
                            <View style={{ flexDirection: 'row', marginTop: 30 }}>
                                <Text onPress={() => this.props.navigation.navigate('Signup',{translationImg,translationOp,opaqueOp,indexOp})} style={{ fontSize: 17, fontWeight: 'bold', opacity: 0.8, fontFamily: 'Roboto', color: '#000000', paddingRight: 10, textDecorationLine: 'underline' }}>Sign Up</Text>
                                <View style={{ flex: 1 }} />
