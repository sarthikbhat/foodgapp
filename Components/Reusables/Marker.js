...
class Marker extends React.Component {
    render() {
        ...
        var height=Dimensions.get('window').height-120
        ...
        return (
            <React.Fragment>
                <View style={{ position: "absolute", zIndex: 99999, left: elm.rect.x*width, top: elm.rect.y*height-5, height: elm.rect.h*height-5, width: elm.rect.w*width, borderWidth:2, borderColor:"red" }} >
