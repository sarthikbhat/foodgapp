...
import { Text, Image, View, ScrollView, StatusBar, TextInput, TouchableNativeFeedback, StyleSheet, ImageBackground, Dimensions, LayoutAnimation, UIManager, ActivityIndicator } from 'react-native'
            ...
            <View style={{ paddingTop: 5, flex: 1, backgroundColor: '#ebebeb' }}>
                ...
                <ImageBackground source={require('../../Assets/images/appbg.png')} style={styles.outerMenu} imageStyle={styles.imageMenu}>
                  ...
                  {/* <Button title={"Scheduled (30s) Notification"} onPress={() => { this.notification.scheduleNotification() }} /> */}
                                ...
                                this.state.index == 1 ? <Ingredients /> : <Profile />
